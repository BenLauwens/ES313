...
# ╔═╡ 7d4ea3f8-42a4-4039-bcbf-e17a46eb9312
using Plots
...
# ╔═╡ faf8f4f7-7ec2-4b60-a2d4-1ef09a74ba48
# change pwd to the one of the notebook
cd(dirname(@__FILE__))

# ╔═╡ 82a2c2e8-ac0a-4a50-a29f-d75db25dc77e
pwd()
...
R = regles("./data/Langtonsrules.txt");

# ╔═╡ 548b40b4-4a5d-4a00-93d6-5bd5aebb1db7
M = monde("./data/Langtonstart.txt");
...
# ╔═╡ 4a00f909-5c28-4e6c-893d-479dca2734fb
