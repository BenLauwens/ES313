...
# ╔═╡ 374316e0-0fab-11eb-2c7c-9fc215172378
#using Pkg

# ╔═╡ 51c03f6e-0fab-11eb-3508-d986894341f0
#begin
#	pkg"add SimJulia"
...
begin
	σt = CSV.read("sigma_total.txt", DataFrame)
	σf = CSV.read("sigma_fission.txt", DataFrame)
	σa = CSV.read("sigma_absorption.txt", DataFrame)
	σi = CSV.read("sigma_inelastic.txt", DataFrame)
end;
